...
- **[effect-hatchet](https://github.com/fdarian/effect-hatchet)** — Effect-native bindings for Hatchet, with an in-memory implementation so the same task graph runs under Vitest without an engine.
...
- **[create-hardhat-dapp](https://github.com/fdarian/create-hardhat-dapp)** — Zero-config scaffolding for Hardhat development environments with TypeScript, ethers, and Waffle preconfigured.
